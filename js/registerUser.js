    ...
    $.ajax({
      ...
      success: function(data) {
        if (data.type == 'error') {
          ...
          //                    return true;
          output =
            '<div class="error" style="color: #00aee4;">Successful, redirecting you... <i id="waiting" class="fa fa-cog fa-spin fa-3x fa-fw" style="color: #00aee4;font-size: 18px;left: 0;top: 0;position: relative;"></i></div> ';
          $('#loginresult')
            .hide()
            .html(output)
            .slideDown();
