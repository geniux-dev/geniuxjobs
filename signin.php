...
if ($resultE->num_rows > 0) {
    ...
    $output = json_encode(array('type' => 'success', 'text' => 'Login successful'.$_SESSION["login_employer"]));
    die($output);
...
if ($resultS->num_rows > 0) {
    ...
    $output = json_encode(array('type' => 'success', 'text' => 'Login successful'.$_SESSION["login_user"]));
    die($output);
